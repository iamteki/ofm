{{-- resources/views/frontend/sections/about/team-full.blade.php --}}
<section class="team-section about-page sec-pad">
    <div class="auto-container">
        ...
        <div class="three-item-carousel owl-carousel owl-theme">
            ...
            @endforeach
            {{-- Duplicate for continuous carousel --}}
            @foreach($team as $member)
            <div class="team-block-one">
                <div class="inner-box">
                    <figure class="image-box"><img src="{{ asset($member['image']) }}" alt="{{ $member['name'] }}"></figure>
        ...
        <div class="more-text centred">
            <h5><a href="#">View All Members<i class="flaticon-right-chevron"></i></a></h5>
        </div>
    </div>
</section>