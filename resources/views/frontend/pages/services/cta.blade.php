...
{{-- resources/views/frontend/sections/services/cta.blade.php --}}
<section class="cta-section alternat-2">
    <div class="outer-container">
        ...
        <div class="image-box-two">
            ...
            <div class="text-box">
                <h6>Ready to <br />Start Your <br />Journey?</h6>
            </div>
        </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-8 col-md-12 col-sm-12 offset-lg-2 content-column">
                    <div class="content-box">
                        <h2>Trust us with <br />your financial future</h2>
                        <div class="inner-box">
                            <figure class="image-box"><img src="{{ asset('assets/images/resource/cart-1.jpg') }}" alt=""></figure>
                            <p>Take the first step towards financial freedom with our expert guidance and proven strategies.</p>
