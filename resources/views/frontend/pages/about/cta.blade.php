{{-- resources/views/frontend/sections/about/cta.blade.php --}}
            ...
            <div class="row clearfix">
                <div class="col-lg-8 col-md-12 col-sm-12 offset-lg-2 content-column">
                    <div class="content-box">
                        <h2>Partner with us for <br />financial success</h2>
                        <div class="inner-box">
                            ...
                            <a href="{{ route('contact') }}" class="theme-btn btn-two">Get Started</a>
                        </div>
                    </div>
                </div>
            </div>
